...
@Configuration
public class Routes {
    //Using Functional End Point Programming model
    @Bean
    ...
    public RouterFunction<ServerResponse> fallbackRoute() {
        return route(RequestPredicates.GET("/fallbackRoute"), request -> ServerResponse.status(HttpStatus.SERVICE_UNAVAILABLE)
